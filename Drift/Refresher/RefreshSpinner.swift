...
struct RefreshSpinnerView<RefreshView: View>: View {
...
struct SystemStyleRefreshSpinner<RefreshView: View>: View {
...
struct System2StyleRefreshSpinner<RefreshView: View>: View {
    var opacityClipPoint: CGFloat
